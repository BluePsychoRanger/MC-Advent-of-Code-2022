...
execute as @e[type=marker,tag=aoc_tail_1] at @s run function aoc_2022:logic/day_9/visual_2/move_tail/1

scoreboard players remove step aoc_calc 1
execute if score step aoc_calc matches 1.. at @s run function aoc_2022:logic/day_9/visual_2/move_head
