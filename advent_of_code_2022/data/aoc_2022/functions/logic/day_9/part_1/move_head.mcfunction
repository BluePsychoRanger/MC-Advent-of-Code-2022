...
execute as @e[type=marker,tag=aoc_tail] at @s run function aoc_2022:logic/day_9/part_1/move_tail

scoreboard players remove step aoc_calc 1
execute if score step aoc_calc matches 1.. at @s run function aoc_2022:logic/day_9/part_1/move_head
