...
# if in the checked row, store it in a list
execute if score z2 aoc_calc = checkz aoc_calc run function aoc_2022:logic/day_15/part_1/add_beacon
...
# mark area
execute if score d aoc_calc matches 0.. run function aoc_2022:logic/day_15/part_1/add_line/add_positions

# loop for all sensors
execute if score input_length aoc_calc matches 1.. run function aoc_2022:logic/day_15/part_1/loop
