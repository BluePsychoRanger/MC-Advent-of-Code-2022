...
# draw shape
execute at @s run function aoc_2022:logic/day_14/part_2/build/loop_line

# loop for all shapes
execute if score input_length aoc_calc matches 1.. run function aoc_2022:logic/day_14/part_2/build/loop
