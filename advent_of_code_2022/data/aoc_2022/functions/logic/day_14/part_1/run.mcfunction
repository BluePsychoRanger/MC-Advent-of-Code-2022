...
execute as @e[type=marker,tag=aoc_line,limit=1] at @s run function aoc_2022:logic/day_14/part_1/build/loop

execute positioned 500 128 0 run function aoc_2022:logic/day_14/part_1/sand/loop
