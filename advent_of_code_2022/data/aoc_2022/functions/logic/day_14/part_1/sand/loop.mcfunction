...
execute positioned 500 128 0 run function aoc_2022:logic/day_14/part_1/sand/check_loc

execute unless score z aoc_calc > max_z aoc_calc run scoreboard players add answer aoc_answer 1
execute unless score z aoc_calc > max_z aoc_calc run schedule function aoc_2022:logic/day_14/part_1/sand/loop 30t
