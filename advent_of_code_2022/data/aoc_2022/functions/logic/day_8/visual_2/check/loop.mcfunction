...
execute at @e[type=marker,tag=aoc_scan,limit=1] run function aoc_2022:logic/day_8/visual_2/check/loop_string

execute as @e[type=marker,tag=aoc_scan,limit=1] at @s run tp ~ ~ ~1
execute if score input_length aoc_calc matches 1.. run schedule function aoc_2022:logic/day_8/visual_2/check/loop 5t
