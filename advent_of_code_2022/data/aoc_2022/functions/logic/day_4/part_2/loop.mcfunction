...
execute if score max1 aoc_calc >= min2 aoc_calc if score min1 aoc_calc <= max2 aoc_calc run scoreboard players set add aoc_calc 1
execute if score max2 aoc_calc >= min1 aoc_calc if score min2 aoc_calc <= max1 aoc_calc run scoreboard players set add aoc_calc 1
scoreboard players operation answer aoc_answer += add aoc_calc

execute if score input_length aoc_calc matches 1.. run function aoc_2022:logic/day_4/part_2/loop
