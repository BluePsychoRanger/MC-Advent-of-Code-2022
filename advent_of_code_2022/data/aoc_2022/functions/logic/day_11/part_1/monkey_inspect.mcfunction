...
execute unless score desired aoc_calc matches 0 run function aoc_2022:logic/day_11/part_1/find_next_monkey
...
execute if score monkey aoc_calc < monkeys aoc_calc run function aoc_2022:logic/day_11/part_1/monkey_inspect
