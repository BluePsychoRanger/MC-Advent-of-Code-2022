data modify storage aoc:calc monkey set value {items:[],operand:1,operator:1,divisor:1,true:0,false:0,inspected:0}
...
function aoc_library:io/next_token
function aoc_2022:logic/day_11/part_1/init_monkey_items
# operation
function aoc_library:io/next_string
...
execute unless score num_invalid aoc_calc matches 1 store result storage aoc:calc monkey.operand int 1 run scoreboard players get num aoc_calc
...
execute if score input_length aoc_calc matches 1.. run function aoc_2022:logic/day_11/part_1/init_monkeys
