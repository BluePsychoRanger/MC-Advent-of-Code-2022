...
execute if score op aoc_calc matches 0 run function aoc_2022:logic/day_7/part_1/add_file
execute if score op aoc_calc matches 1 run function aoc_2022:logic/day_7/part_1/change_dir

execute if score input_length aoc_calc matches 1.. run function aoc_2022:logic/day_7/part_1/loop
