...
execute if score op bpr_aoc matches 0 run function aoc_2022:logic/day_7/part_2/first/add_file
execute if score op bpr_aoc matches 1 run function aoc_2022:logic/day_7/part_2/first/change_dir

execute if score input_length bpr_aoc matches 1.. run function aoc_2022:logic/day_7/part_2/first/loop
