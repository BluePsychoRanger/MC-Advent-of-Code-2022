...
# 0: move in
execute if score op_1 bpr_aoc matches 0 run function aoc_2022:logic/day_7/part_2/first/cd_subdir
# 1: move out
execute if score op_1 bpr_aoc matches 1 run function aoc_2022:logic/day_7/part_2/first/cd_root
