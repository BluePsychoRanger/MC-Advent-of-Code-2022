...
execute if score num aoc_calc matches 97 run summon marker ~ 1 ~ {Tags:["aoc_traverse"]}
scoreboard players remove num aoc_calc 96

function aoc_2022:logic/day_12/visual_2/build/loop_column

execute if score next_string_length aoc_calc matches 1.. positioned ~1 ~ ~ run function aoc_2022:logic/day_12/visual_2/build/loop_string
