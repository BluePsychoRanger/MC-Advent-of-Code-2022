...
# error checking
execute unless data storage bpr:aoc/library big_int run tellraw @a [{"text":"[ERROR] ","color":"dark_red"},{"text":"No [big_int] set","color":"red"},{"text":" ...aoc_library:functions/string/as_string","color":"aqua"}]
