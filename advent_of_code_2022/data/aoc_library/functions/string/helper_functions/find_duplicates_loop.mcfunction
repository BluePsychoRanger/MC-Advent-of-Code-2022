...
data modify entity @s Tags append from storage aoc:library temp_string[0]
execute store result score tag_count aoc_calc run tag @s list
execute if score tag_count_prev aoc_calc = tag_count aoc_calc run data modify storage aoc:library duplicates append from storage aoc:library temp_string[0]
